...
<template>
  ...
  <Hero sectionKey="powerful_analytics" layout="split" height="nav">
    <HeroContent align="left" padding="md" width="lg" class="space-y-8">
      <Badge variant="outline">Dashboard</Badge>
      <HeroTitle size="3xl">Powerful Analytics</HeroTitle>
      <HeroDescription>
        Get real-time insights into your business performance with our advanced
        analytics dashboard.
      </HeroDescription>
  ...
  <Hero sectionKey="basic_plan" layout="split" height="nav">
    <HeroMedia rounded="none" class="relative h-full bg-secondary/50">
      <div
        class="absolute inset-0 bg-gradient-to-tr from-primary/20 to-primary/5"
      />
    ...
    <HeroContent align="left" padding="md" width="lg">
  ...
  <Hero sectionKey="hero_3" layout="split" height="nav">
    <HeroContent align="left" padding="md" width="lg" class="space-y-8">
      <div class="space-y-4">
        ...
        <blockquote class="text-2xl font-serif italic">
          "This platform has transformed how we handle our analytics. The
          insights we've gained are invaluable."
        </blockquote>
      </div>
    ...
    <HeroMedia rounded="none" class="relative h-full">
      <div
